      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-12 items-center">
        <div className="space-y-6">
          ...
          <div className="flex space-x-4">
            <NavLink to={'products'} className="bg-red-500 text-white px-6 py-2 rounded-full font-medium hover:scale-105 transition-all duration-300 ease-in-out">start shopping</NavLink>
            <NavLink to={'services'} className="bg-gray-300 text-gray-800 px-6 py-2 rounded-full font-medium hover:scale-105 transition-all duration-300 ease-in-out">View services</NavLink>
          </div>
